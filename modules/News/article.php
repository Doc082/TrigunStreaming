...
if ($catid != 0) {
	...
	$title = "<a href=\"modules.php?name=$module_name&amp;file=categories&amp;op=newindex&amp;catid=$catid\"><font class=\"storycat\">$title1</font></a>: $title - Streaming Ita";
}
...
if ($ratings != 0) {
	...
	$r_image = round($rate);
	if ($r_image == 1) {
		$the_image = "<br><br>Voto del pubblico: <br><strong>Fa Cag***e</strong><br><img src=\"images/articles/stars-1.gif\" border=\"1\"></center><br>";
	} elseif ($r_image == 2) {
		$the_image = "<br><br>Voto del pubblico: <br><strong>E' un Mattone!</strong><br><img src=\"images/articles/stars-2.gif\" border=\"1\"></center><br>";
	} elseif ($r_image == 3) {
		$the_image = "<br><br>Voto del pubblico: <br><strong>Si può Guardare...</strong><br><img src=\"images/articles/stars-3.gif\" border=\"1\"></center><br>";
	} elseif ($r_image == 4) {
		$the_image = "<br><br>Voto del pubblico: <br><strong>Bello!</strong><br><img src=\"images/articles/stars-4.gif\" border=\"1\"></center><br>";
	} elseif ($r_image == 5) {
		$the_image = "<br><br>Voto del pubblico: <br><strong>Spettacolare!</strong><br><img src=\"images/articles/stars-5.gif\" border=\"1\"></center><br>";
	}
} else {
	$rate = 0;
	$the_image = "</center><br>";
