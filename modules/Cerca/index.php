...
switch($op) {
	...
	/* Date Selection */
		...
		if ($type=="stories" OR !$type) {
			...
			$q = "select s.sid, s.aid, s.informant, s.title, s.time, s.hometext, s.bodytext, a.url, s.comments, s.counter, s.topic from ".$prefix."_stories s, ".$prefix."_authors a where s.aid=a.aid $queryalang $categ";
