...
$author_name = "nukecoder.com";
$author_email = "";
$author_homepage = "http://nukecoder.com";
$license = "GNU/GPL";
$download_location = "http://nukecoder.com/downloads.html";
$module_version = "1.0";
$module_description = "Live Chat is an ajax based chat script which aims to be lightweight and easy to use.";
