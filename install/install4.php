...
if ($siteUrl) {
	...
	$config .= "# ============================================\n";
	$config .= "#\n";
	$config .= "# Copyright (c) 2006 by Francisco Burzi\n";
	...
	$config .= "# \$gfx_chk:	Set the graphic security code on every login screen,\n";
	...
	$config .= "# \$nuke_editor: Turn On/Off the WYSIWYG text editor\n";
	$config .= "#               0: Off, textareas in forms will not show any editor\n";
	$config .= "#               1: On, all textarea in the forms will show the editor\n";
	$config .= "# \$display_errors:  Debug control to see PHP generated errors.\n";
