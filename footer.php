...
function footmsg() {
	...
	if ($commercial_license == 1) {
		$footmsg .= $total_time."<br><br>\n</span>\n";
	} else {
		$footmsg .= "<br>$total_time<br>\n</span>\n";
	}
	echo $footmsg;
}
...
function foot() {
	...
	echo "<br><br><br><br>\n";
	echo "<center><script src=\"http://www.grix.it/sitePromo/grixPromo.php?un=Doc82&ck=bi4mi1SD0w\"></script></center>\n";
	echo "<br><br><br><br>\n";
	echo "<div align='center'>\n";
	echo "<!-- Inizio Codice ShinyStat -->\n";
	echo "<script type=\"text/javascript\" src=\"http://codice.shinystat.com/cgi-bin/getcod.cgi?USER=spitfire82\"></script>\n";
	echo "<noscript>\n";
	echo "<a href=\"http://www.shinystat.com/it\" target=\"_top\">\n";
	echo "<img src=\"http://www.shinystat.com/cgi-bin/shinystat.cgi?USER=spitfire82\" alt=\"Contatore accessi gratuito\" border=\"0\" /></a>\n";
	echo "</noscript>\n";
	echo "<!-- Fine Codice ShinyStat -->\n";
	echo "</div>";
	echo "</body>\n</html>";
    ob_end_flush();
	die();
